...
function createBpn() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@10.184.0.11:7054 --caname ca.bpn.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/bpn/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/10-184-0-11-7054-ca-bpn-example-com.pem
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.11:7054 --caname ca.bpn.example.com -M "${PWD}/organizations/peerOrganizations/bpn.example.com/peers/peer0.bpn.example.com/msp" --csr.hosts peer0.bpn.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/bpn/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.11:7054 --caname ca.bpn.example.com -M "${PWD}/organizations/peerOrganizations/bpn.example.com/peers/peer0.bpn.example.com/tls" --enrollment.profile tls --csr.hosts peer0.bpn.example.com --csr.hosts "10.184.0.11" --tls.certfiles "${PWD}/organizations/fabric-ca/bpn/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@10.184.0.11:7054 --caname ca.bpn.example.com -M "${PWD}/organizations/peerOrganizations/bpn.example.com/users/User1@bpn.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/bpn/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://bpnadmin:bpnadminpw@10.184.0.11:7054 --caname ca.bpn.example.com -M "${PWD}/organizations/peerOrganizations/bpn.example.com/users/Admin@bpn.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/bpn/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createSupplyChain() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/10-184-0-6-8054-ca-supplychain-example-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/10-184-0-6-8054-ca-supplychain-example-com.pem
    OrganizationalUnitIdentifier: peer
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@10.184.0.11:9054 --caname ca.orderer.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/10-184-0-11-9054-ca-orderer-example-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/10-184-0-11-9054-ca-orderer-example-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@10.184.0.11:9054 --caname ca.orderer.example.com -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp" --csr.hosts orderer.example.com --csr.hosts 10.184.0.11 --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@10.184.0.11:9054 --caname ca.orderer.example.com -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/tls" --enrollment.profile tls --csr.hosts orderer.example.com --csr.hosts 10.184.0.11 --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@10.184.0.11:9054 --caname ca.orderer.example.com -M "${PWD}/organizations/ordererOrganizations/example.com/users/Admin@example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
