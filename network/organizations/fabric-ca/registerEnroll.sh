...
function createKementrian() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@10.184.0.8:7054 --caname ca.kementrian.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/10-184-0-8-7054-ca-kementrian-example-com.pem
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.8:7054 --caname ca.kementrian.example.com -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/peers/peer0.kementrian.example.com/msp" --csr.hosts peer0.kementrian.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@10.184.0.8:7054 --caname ca.kementrian.example.com -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/users/User1@kementrian.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://kementrianadmin:kementrianadminpw@10.184.0.8:7054 --caname ca.kementrian.example.com -M "${PWD}/organizations/peerOrganizations/kementrian.example.com/users/Admin@kementrian.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/kementrian/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createSupplyChain() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/10-184-0-9-8054-ca-supplychain-example-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/10-184-0-9-8054-ca-supplychain-example-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.9:8054 --caname ca.supplychain.example.com -M "${PWD}/organizations/peerOrganizations/supplychain.example.com/peers/peer0.supplychain.example.com/msp" --csr.hosts peer0.supplychain.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/supplychain/ca-cert.pem"
  { set +x; } 2>/dev/
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@10.184.0.9:8054 --caname ca.supplychain.example.com -M "${PWD}/organizations/peerOrganizations/supplychain.example.com/peers/peer1.supplychain.example.com/msp" --csr.hosts peer1.supplychain.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/supplychain/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.9:8054 --caname ca.supplychain.example.com -M "${PWD}/organizations/peerOrganizations/supplychain.example.com/peers/peer0.supplychain.example.com/tls" --enrollment.profile tls --csr.hosts peer0.supplychain.example.com --csr.hosts "10.184.0.9" --tls.certfiles "${PWD}/organizations/fabric-ca/supplychain/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer1-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@10.184.0.9:8054 --caname ca.supplychain.example.com -M "${PWD}/organizations/peerOrganizations/supplychain.example.com/peers/peer1.supplychain.example.com/tls" --enrollment.profile tls --csr.hosts peer1.supplychain.example.com --csr.hosts "10.184.0.10" --tls.certfiles "${PWD}/organizations/fabric-ca/supplychain/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@10.184.0.9:8054 --caname ca.supplychain.example.com -M "${PWD}/organizations/peerOrganizations/supplychain.example.com/users/User1@supplychain.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/supplychain/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://supplychainadmin:supplychainadminpw@10.184.0.9:8054 --caname ca.supplychain.example.com -M "${PWD}/organizations/peerOrganizations/supplychain.example.com/users/Admin@supplychain.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/supplychain/ca-cert.pem"
  { set +x; } 2>/dev/null
