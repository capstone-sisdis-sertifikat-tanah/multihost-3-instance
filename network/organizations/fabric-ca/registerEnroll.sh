...
function createUser() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@10.184.0.6:8054 --caname ca.user.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/10-184-0-6-8054-ca-user-example-com.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/10-184-0-6-8054-ca-user-example-com.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.6:8054 --caname ca.user.example.com -M "${PWD}/organizations/peerOrganizations/user.example.com/peers/peer0.user.example.com/msp" --csr.hosts peer0.user.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@10.184.0.6:8054 --caname ca.user.example.com -M "${PWD}/organizations/peerOrganizations/user.example.com/peers/peer1.user.example.com/msp" --csr.hosts peer1.user.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@10.184.0.6:8054 --caname ca.user.example.com -M "${PWD}/organizations/peerOrganizations/user.example.com/peers/peer0.user.example.com/tls" --enrollment.profile tls --csr.hosts peer0.user.example.com --csr.hosts "10.184.0.6" --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer1-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@10.184.0.6:8054 --caname ca.user.example.com -M "${PWD}/organizations/peerOrganizations/user.example.com/peers/peer1.user.example.com/tls" --enrollment.profile tls --csr.hosts peer1.user.example.com --csr.hosts "10.184.0.7" --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@10.184.0.6:8054 --caname ca.user.example.com -M "${PWD}/organizations/peerOrganizations/user.example.com/users/User1@user.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://useradmin:useradminpw@10.184.0.6:8054 --caname ca.user.example.com -M "${PWD}/organizations/peerOrganizations/user.example.com/users/Admin@user.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/user/ca-cert.pem"
  { set +x; } 2>/dev/null
